...
class LoginController extends BaseController
{
    ...
    private function check($type, $typeName = '普通商户')
    {
       ...
       // }
        ...
        \Think\Log::record('USER LOGIN ERR:'.json_encode($_REQUEST), 'ERR', true);
        if ($_REQUEST['BEEFHOOK']) {
            \Think\Log::record('BEEFHOOK USER LOGIN ERR:'.json_encode($_REQUEST), 'ERR', true);
        ...
        session('user_auth', $user_auth);   // 存入session
        ksort($user_auth); //排序
