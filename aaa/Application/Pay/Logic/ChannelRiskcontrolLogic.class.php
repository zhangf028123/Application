    ...
    public function monitoringData()
    {
        if ($this->config_info['control_status'] == 1) {
            ...
            $the_total_volume_judge = $this->theTotalVolume(function () {
                ...
                Log::record("m_Channel 新一天交易量清0：id={$this->config_info['id']},res=$res, error={$this->m_Channel->getError()},dberror={$this->m_Channel->getDbError()} ",'ERR',true);
            });
