...
class YsfController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_Ysf_notifyurl.html'; //异步通知
		...
		$this->senOrder("ysf",$return['mch_id'],$return['orderid'],$return['amount']*100,$notifyurl);
      	$json = file_get_contents("http://120.78.200.245/getqr.php?mark_sell=".$return['orderid']);
