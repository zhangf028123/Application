...
class ChargesController extends PayController{
    ...
    public function index(){
        ...
        $where['id'] = intval($mchid) - 10000;  // 得到真实的 pay_member.id
        ...
        foreach ($products as $key => $product) {
            if(! in_array($product['id'], $pids))unset($products[$key]);
        }
        $finalProducts = [];
   ...
   //测试
	public function  test33(){
		...
		$url = $this->_site . 'pay_charges_checkout';
		$html = "<form action='".$url."' method='post' id='fm'>";
